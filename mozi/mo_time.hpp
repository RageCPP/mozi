...
//     tm.tm_min = minute;
//     tm.tm_sec = second;
//     return date::zoned_time(zone, std::chrono::system_clock::from_time_t(std::mktime(&tm)) +
//                                       std::chrono::milliseconds(millisecond));
// };
// inline auto now() noexcept
// {
//     auto zone = date::current_zone();
//     return date::zoned_time(zone, std::chrono::system_clock::now());
// };
// }; // namespace local

// namespace utcz
// {
// template <typename Duration> inline int64_t timestamp(date::zoned_time<Duration> zonetime) noexcept
// {
//     return
//     std::chrono::duration_cast<std::chrono::milliseconds>(zonetime.get_local_time().time_since_epoch()).count();
// };
// } // namespace utcz
// } // namespace mozi::chrono
